...
{
    [Binding]
    public class AgentTC81_IL2_StepDefinition : BasePage
    {
        ...
        public AgentTC81_IL2_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            // _commonFunctions.CheckAllMessageOverrideCheckboxes();
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary4_Address1, "719 E North Grand Ave", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary4_Address2, "Springfield, IL 62702-137", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary4_EffectiveDateText1, "Effective Date", true, 1);
        }
        ...
        {
            await page.WaitForTimeoutAsync(4000);
            await Label.VerifyTextAsync(_commonXpath.DFSummary4_CoverageLPremisesLiability1, "$500,000 per occurrence / $1,000,000 per aggregate", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary4_CoverageMMedicalPayments1, "5,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary4_AllPerilsDeductible, "1,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary4_WindOrHailDeductible, "2,000", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "1665", true, 1);
        }
