...
{
    [Binding]
    public class AgentTC81_KS2_StepDefinition : BasePage
    {
        ...
        public AgentTC81_KS2_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary8_Address1, "201 S Main St", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary8_Address2, "Pratt, KS 67124-101", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary8_EffectiveDateText1, "Effective Date", true, 1);
        }
        ...
        {
            await page.WaitForTimeoutAsync(4000);
            await Label.VerifyTextAsync(_commonXpath.DFSummary8_CoverageLPremisesLiability1, "$500,000 per occurrence / $1,000,000 per aggregate", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary8_CoverageMMedicalPayments1, "5,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary8_AllPerilsDeductible, "2,500", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary8_WindOrHailDeductible, "5,000", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "3439", true, 1);
        }
