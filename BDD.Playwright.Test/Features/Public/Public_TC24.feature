...
Scenario: Public_TC24
	...
	When User enters policy details and submit button on Make a Payment page from "MakeAclaimStartTC24"
    When User clicks on submit with index 2
    When User selects payment type and plan then enters payment and banking and insured information then proceeds to review from "MakeAPaymentTC24"
