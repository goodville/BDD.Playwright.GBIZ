...
{
    [Binding]
    public class AgentTC81_VA1_StepDefinition : BasePage
    {
        ...
        public AgentTC81_VA1_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary14_Address1, "1291 S Boston Rd", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary14_Address2, "Danville, VA 24540-105", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary14_EffectiveDateText1, "Effective Date", true, 1);
        }
        ...
        {
            await page.WaitForTimeoutAsync(4000);
            await Label.VerifyTextAsync(_commonXpath.DFSummary14_CoverageLPremisesLiability1, "$300,000 per occurrence / $600,000 per aggregate", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary14_CoverageMMedicalPayments1, "2,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary14_AllPerilsDeductible, "500", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary14_WindOrHailDeductible, "1,000", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "606", true, 1);
        }
