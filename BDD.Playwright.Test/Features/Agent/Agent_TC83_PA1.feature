Feature: Agent_TC83_PA1

Scenario Outline: Agent_TC83_PA1
	...
	Then Verify Homeowner Applicant information displayed on Summary page for PA1.
	Then Verify Homeowner Limits of Insurance information displayed on Summary page for PA1.
	Then Verify Homeowner Total premium amount displayed on Summary page for PA1.
