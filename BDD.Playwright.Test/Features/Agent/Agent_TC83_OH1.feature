Feature: Agent_TC83_OH1

Scenario Outline: Agent_TC83_OH1
	...
	Then Verify Homeowner Applicant information displayed on Summary page for OH1.
	Then Verify Homeowner Limits of Insurance information displayed on Summary page for OH1.
	Then Verify Homeowner Total premium amount displayed on Summary page for OH1.
