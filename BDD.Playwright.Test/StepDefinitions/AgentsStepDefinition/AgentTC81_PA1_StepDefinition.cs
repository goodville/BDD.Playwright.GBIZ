...
{
    [Binding]
    public class AgentTC81_PA1_StepDefinition : BasePage
    {
        ...
        public AgentTC81_PA1_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary12_Address1, "625 W Main St", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary12_Address2, "New Holland, PA 17557-132", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary12_EffectiveDateText1, "Effective Date", true, 1);
        }
        ...
        public async Task VerifyLimitsofInsuranceinformationSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.DFSummary12_AllPerilsDeductible, "500", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary12_WindOrHailDeductible, "1,000", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "748", true, 1);
        }
