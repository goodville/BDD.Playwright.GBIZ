...
Scenario: Agent_TC82_OK1
	...
	When User enter the mandatory fields in the New Quote Page for the Farm Owner
	When User Click on Next Button
	When User enter the Location details in the Farm Owner page
	When User Click on Next Button
	When User Click on Add Dwelling and enter the fields
	When User Click on Next Button
	When User Navigates to Add Structure page
	When User navigates to coverageFarmOwNer Page
	And user navigates to FarmPropF button
	When User navigates to FarmProperty page
	And User navigates to FarmPropG button
	And User NAvigates to Deduct drpdown
	And User Navigates to Libilty subTAB
	When Navigates to libility subTab Page
