Feature: Agent_TC83_KS1

Scenario Outline: Agent_TC83_KS1
	...
	Then Verify Homeowner Applicant information displayed on Summary page for KS1.
	Then Verify Homeowner Limits of Insurance information displayed on Summary page for KS1.
	Then Verify Homeowner Total premium amount displayed on Summary page for KS1.
