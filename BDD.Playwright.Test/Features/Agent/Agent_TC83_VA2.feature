Feature: Agent_TC83_VA2

Scenario Outline: Agent_TC83_VA2
	...
	Then Verify Homeowner Applicant information displayed on Summary page for VA2.
	Then Verify Homeowner Limits of Insurance information displayed on Summary page for VA2.
	Then Verify Homeowner Total premium amount displayed on Summary page for VA2.
