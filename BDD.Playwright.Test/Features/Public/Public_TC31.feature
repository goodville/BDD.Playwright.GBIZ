...
Scenario: Public_TC31
	...
	When User enters policy details and submit button on Make a Payment page from "MakeAclaimStartTC31"
    When User clicks on submit with index 2
	And User selects payment type and plan then enters payment and banking and insured information then proceeds to review from "MakeAPaymentTC31"
