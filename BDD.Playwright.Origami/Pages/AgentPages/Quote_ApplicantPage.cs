    ...
    public class Quote_ApplicantPage : BasePage
    {
        ...
        public async Task ApplicantDatafillAsync()
        {
            ...
            if (commonFunctions.isMailingAddress_Radio_LabelAndValue.Item2 != string.Empty)
            {
                ...
                {
                    string isMailingAddress_Radio1 = string.Format(isMailingAddress_Radio, commonFunctions.isMailingAddress_Radio_LabelAndValue.Item2);
        ...
        public async Task WorkersCompUnderwritngInfofilAsync()
        {
            commonFunctions.ReadTestDataForApplicantPage();
            commonFunctions.UserWaitForPageToLoadCompletly();
            //commonFunctions.WaitForOverlayToDisappear(Driver);
        ...
        public async Task CommercialUmbrellaApplicantDatafillAsync()
        {
            commonFunctions.ReadTestDataForApplicantPage();
            ...
            commonFunctions.UserWaitForPageToLoadCompletly();
            await Task.Delay(5000); // Wait for the Billing page to load
            // For input fields
