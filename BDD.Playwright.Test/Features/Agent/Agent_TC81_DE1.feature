Feature: Agent_TC81_DE1

Scenario Outline: Agent_TC81_DE1
	...
	When User fills mandatory field in applicant page and click continue button from json "Agent_TC81_DE1"
	And User fills mandatory field in coverages page and click continue button from json "Agent_TC81_DE1"
	And User fills mandatory field in dwelling page and click continue button from json "Agent_TC81_DE1"
	...
	And User fills the mandatory field in the Additional information Mortgageepage from json "Agent_TC81_DE1"
	And User fills the mandatory field in the Billing page and Verify the 6Paypayment plans are displayed
	And User fills the mandatory field in the Binding page and click Bind Policybutton from json "Agent_TC81_DE1"
