Feature: Agent_TC83_PA2

Scenario Outline: Agent_TC83_PA2
	...
	When User fills the mandatory field in Homeowner Applicant Page and Click continue button.
	...
	Then Verify Homeowner Applicant information displayed on Summary page for PA2.
	Then Verify Homeowner Limits of Insurance information displayed on Summary page for PA2.
	Then Verify Homeowner Total premium amount displayed on Summary page for PA2.
