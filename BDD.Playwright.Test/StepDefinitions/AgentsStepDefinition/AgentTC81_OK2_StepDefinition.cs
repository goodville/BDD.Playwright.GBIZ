...
{
    [Binding]
    public class AgentTC81_OK2_StepDefinition : BasePage
    {
        ...
        public AgentTC81_OK2_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary11_Address1, "2600 Amy Ct", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary11_Address2, "Oklahoma City, OK 73160-131", true, 1);
        ...
        {
            await page.WaitForTimeoutAsync(4000);
            await Label.VerifyTextAsync(_commonXpath.DFSummary11_CoverageLPremisesLiability1, "$500,000 per occurrence / $1,000,000 per aggregate", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary11_CoverageMMedicalPayments1, "5,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary11_AllPerilsDeductible, "2,500", true, 1);
            //await Label.VerifyValueAsync(_commonXpath.DFSummary11_WindOrHailDeductible, "Not Applicable", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "2463", true, 1);
        }
