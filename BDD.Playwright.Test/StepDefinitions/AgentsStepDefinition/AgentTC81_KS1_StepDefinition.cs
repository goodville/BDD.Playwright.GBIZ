...
{
    [Binding]
    public class AgentTC81_KS1_StepDefinition : BasePage
    {
        ...
        public AgentTC81_KS1_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary7_Address1, "714 N Main St", true, 1);
            // await Label.VerifyTextAsync(_commonXpath.DFSummary7_Address2, "Newton, KS 67114-1830", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary7_EffectiveDateText1, "Effective Date", true, 1);
        }
        ...
        {
            await page.WaitForTimeoutAsync(4000);
            await Label.VerifyTextAsync(_commonXpath.DFSummary7_CoverageLPremisesLiability1, "$300,000 per occurrence / $600,000 per aggregate", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary7_CoverageMMedicalPayments1, "2,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary7_AllPerilsDeductible, "1,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary7_WindOrHailDeductible, "2,000", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "1236", true, 1);
        }
