...
{
    [Binding]
    public class AgentTC81_IN1_StepDefinition : BasePage
    {
        ...
        public AgentTC81_IN1_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary5_Address1, "20327 Dean Rd", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary5_Address2, "Harlan, IN 46743-139", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary5_EffectiveDateText1, "Effective Date", true, 1);
        }
        ...
        {
            await page.WaitForTimeoutAsync(4000);
            await Label.VerifyTextAsync(_commonXpath.DFSummary5_CoverageLPremisesLiability1, "$300,000 per occurrence / $600,000 per aggregate", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary5_CoverageMMedicalPayments1, "2,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary5_AllPerilsDeductible, "500", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary5_WindOrHailDeductible, "1,000", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "919", true, 1);
        }
