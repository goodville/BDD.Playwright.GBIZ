...
{
    [Binding]
    public class AgentTC81_IN2_StepDefinition : BasePage
    {
        ...
        public AgentTC81_IN2_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary6_Address1, "921 E 9th St", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary6_Address2, "Rochester, IN 46975-146", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary6_EffectiveDateText1, "Effective Date", true, 1);
        }
        ...
        {
            await page.WaitForTimeoutAsync(4000);
            await Label.VerifyTextAsync(_commonXpath.DFSummary6_CoverageLPremisesLiability1, "$500,000 per occurrence / $1,000,000 per aggregate", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary6_CoverageMMedicalPayments1, "5,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary6_AllPerilsDeductible, "1,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary6_WindOrHailDeductible, "2,000", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "2175", true, 1);
        }
