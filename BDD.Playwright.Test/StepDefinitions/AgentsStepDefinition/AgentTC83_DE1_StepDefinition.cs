...
{
    [Binding]
    public class AgentTC83_DE1_StepDefinition : BasePage
    {
        ...
        public AgentTC83_DE1_StepDefinition(
        ...
        public async Task ThenVerifyHomeOwnerApplicantInformationDisplayedOnTheSummaryPageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.HO_MailingAddress1, "98 Mill St", true, 1);
            await Label.VerifyTextAsync(_commonXpath.HO_PropertyAddress1, "98 Mill St", true, 1);
        ...
        public async Task VerifyHomeOwnerLimitsOfInsuranceInformationDisplayedOnTheSummaryPageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.HO_HomeCoverExtraEndorsement_Label, "Home Cover Extra Endorsement", true, 1);
            await Label.VerifyTextAsync(_commonXpath.HO_ProtectiveDevices_Amount1, "-14", true, 1);
        }
        ...
        public async Task ThenVerifyHomeOwnerTotalPremiumAmountDisplayedOnTheSummaryPageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.HO_EstimatedPremium, "759", true, 1);
        ...
        public async Task UserFillsMandatoryFieldsinBillingpageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.HO6PayPremium1, "127", true, 1);
            await Label.GetTextAsync(_commonXpath.HO6PayPremium2, true, 1);
            await Label.VerifyValueAsync(_commonXpath.HO6PayPremium2, "130", true, 1);
            await Label.GetTextAsync(_commonXpath.HO6PayPremium3, true, 1);
            await Label.VerifyValueAsync(_commonXpath.HO6PayPremium3, "131", true, 1);
            await Label.GetTextAsync(_commonXpath.HO6PayPremium4, true, 1);
            await Label.VerifyValueAsync(_commonXpath.HO6PayPremium4, "130", true, 1);
            await Label.GetTextAsync(_commonXpath.HO6PayPremium5, true, 1);
            await Label.VerifyValueAsync(_commonXpath.HO6PayPremium5, "131", true, 1);
            await Label.GetTextAsync(_commonXpath.HO6PayPremium6, true, 1);
            await Label.VerifyValueAsync(_commonXpath.HO6PayPremium6, "130", true, 1);
            await Label.GetTextAsync(_commonXpath.HO6TotalPremium1, true, 1);
            await Label.VerifyValueAsync(_commonXpath.HO6TotalPremium1, "779", true, 1);
            await page.WaitForTimeoutAsync(3000);
