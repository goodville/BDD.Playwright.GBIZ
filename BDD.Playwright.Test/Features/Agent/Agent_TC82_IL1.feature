Feature: Agent_TC82_IL1

A short summary of the feature

@tag1
Scenario: Agent_TC82_IL1
	...
	And User enter the mandatory fields in the New Quote Page for the Farm Owner from json "Agent_TC82_IL1"
	When User Click on Next Button
	And User enter the Location details in the Farm Owner page from json "Agent_TC82_IL1"
	When User Click on Next Button
	And User Click on Add Dwelling and enter the fields from json "Agent_TC82_IL1"
	When User Click on Next Button
	When User Navigates to Add Structure page
	And User navigates to coverageFarmOwNer Page from json "Agent_TC82_IL1"
	And user navigates to FarmPropF button
	And User navigates to FarmProperty page from json "Agent_TC82_IL1"
	And User navigates to FarmPropG button
	And User NAvigates to Deduct drpdown
	And User Navigates to Libilty subTAB
	And Navigates to libility subTab Page from json "Agent_TC82_IL1"
	...
	When User NAvigates to the billing tab
	When User NavIGAtes to Binding Tab
	And User Navigates to producer tab from json "Agent_TC82_IL1"
