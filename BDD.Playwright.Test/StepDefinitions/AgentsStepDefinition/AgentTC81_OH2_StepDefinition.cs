...
{
    [Binding]
    public class AgentTC81_OH2_StepDefinition : BasePage
    {
        ...
        public AgentTC81_OH2_StepDefinition(
        ...
        public async Task VerifyApplicantinformationonSummarypageAsync()
        {
            ...
            await Label.VerifyTextAsync(_commonXpath.DFSummary10_Address1, "1029 Refugee Rd", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary10_Address2, "Pickerington, OH 43147-133", true, 1);
            await Label.VerifyTextAsync(_commonXpath.DFSummary10_EffectiveDateText1, "Effective Date", true, 1);
        }
        ...
        {
            await page.WaitForTimeoutAsync(4000);
            await Label.VerifyTextAsync(_commonXpath.DFSummary10_CoverageLPremisesLiability1, "$500,000 per occurrence / $1,000,000 per aggregate", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary10_CoverageMMedicalPayments1, "5,000", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary10_AllPerilsDeductible, "2,500", true, 1);
            await Label.VerifyValueAsync(_commonXpath.DFSummary10_WindOrHailDeductible, "5,000", true, 1);
            await page.WaitForTimeoutAsync(4000);
        }
        ...
        public async Task VerifyTotalpremiumAmountdisplayedonSummarypageAsync()
        {
            ...
            await Label.VerifyValueAsync(_commonXpath.TotalPremium, "1794", true, 1);
        }
