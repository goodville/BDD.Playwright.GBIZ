Feature: Agent_TC80_6

Scenario Outline: Agent_TC80_6
	...
	When user completes the mandatory fields in the Business cover new quote page from "Agent_TC80_6"
	And user completes the mandatory fields in the Business cover location page from "Agent_TC80_6"
	And user completes the mandatory fields in the Building page and presses next from "Agent_TC80_6"
	And user completes the mandatory fields in the Business cover coverage page and presses next from "Agent_TC80_6"
	...
	And user completes the required fields on the BC Binding page from "Agent_TC80_6"
